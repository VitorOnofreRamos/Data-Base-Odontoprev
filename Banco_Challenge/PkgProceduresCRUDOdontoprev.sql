CREATE OR REPLACE PACKAGE Pkg_Procedures_CRUD_Odontoprev AS
  ...
  -- Procedures para Hist�rico de Consulta
...
CREATE OR REPLACE PACKAGE BODY Pkg_Procedures_CRUD_Odontoprev AS
    ...
    BEGIN
        ...
        IF Pkg_Fun_Validacao_Odontoprev.Valida_Paciente_Insert(p_Nome, p_Data_Nascimento, p_CPF, p_Telefone, p_Carteirinha, p_ID_Endereco) THEN
            ...
            COMMIT;
        ELSE
            DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada.');
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
	...
	BEGIN
		-- Valida��o dos dados do Dentista
		IF Pkg_Fun_Validacao_Odontoprev.Valida_Dentista_Insert(p_Nome, p_CRO, UPPER(p_Especialidade), p_Telefone) THEN
			...
			COMMIT;
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para inser��o de Dentista.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
	...
	BEGIN
		...
		IF Pkg_Fun_Validacao_Odontoprev.Valida_Dentista_Update(p_ID_Dentista, p_Nome, p_CRO, UPPER(p_Especialidade), p_Telefone) THEN
			...
			COMMIT;
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para atualiza��o de Dentista.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
	...
	BEGIN
		-- Validar informa��es da consulta com a fun��o Valida_Consulta_Insert
		...
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para a consulta.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
	...
	BEGIN
		-- Valida��o dos dados da consulta
		IF Pkg_Fun_Validacao_Odontoprev.Valida_Consulta_Update(p_ID_Consulta, p_Data_Consulta, p_ID_Paciente, p_ID_Dentista, UPPER(p_Status)) THEN
			...
			COMMIT;
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para atualiza��o de Consulta.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
    ...
    -- Procedure para Inserir Hist�rico de Consulta
    PROCEDURE Insert_Historico_Consulta(
		p_ID_Consulta Historico_Consulta.ID_Consulta%TYPE,
		p_Data_Atendimento Historico_Consulta.Data_Atendimento%TYPE,
		p_Motivo_Consulta Historico_Consulta.Motivo_Consulta%TYPE,
	...
	BEGIN
		...
		IF Pkg_Fun_Validacao_Odontoprev.Valida_Historico_Consulta_Insert(p_ID_Consulta, p_Data_Atendimento, p_Motivo_Consulta) THEN
			...
			DBMS_OUTPUT.PUT_LINE('Hist�rico de consulta inserido com sucesso.');
			COMMIT;
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para inser��o de hist�rico de consulta.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
			DBMS_OUTPUT.PUT_LINE('Erro ao inserir hist�rico de consulta: ' || SQLERRM);
			ROLLBACK;
	END Insert_Historico_Consulta;
    
    -- Procedure para Atualizar Hist�rico de Consulta
    PROCEDURE Update_Historico_Consulta(
		p_ID_Historico Historico_Consulta.ID_Historico%TYPE,
		p_ID_Consulta Historico_Consulta.ID_Consulta%TYPE DEFAULT NULL,
		p_Data_Atendimento Historico_Consulta.Data_Atendimento%TYPE DEFAULT NULL,
	...
	BEGIN
		...
		IF Pkg_Fun_Validacao_Odontoprev.Valida_Historico_Consulta_Update(p_ID_Historico, p_ID_Consulta, p_Data_Atendimento, p_Motivo_Consulta) THEN
			...
			DBMS_OUTPUT.PUT_LINE('Hist�rico de consulta atualizado com sucesso.');
			COMMIT;
		ELSE
			DBMS_OUTPUT.PUT_LINE('Erro na valida��o dos dados de entrada para atualiza��o de hist�rico de consulta.');
		END IF;
	EXCEPTION
		WHEN OTHERS THEN
			DBMS_OUTPUT.PUT_LINE('Erro ao atualizar hist�rico de consulta: ' || SQLERRM);
			ROLLBACK;
	END Update_Historico_Consulta;
    
    -- Procedure para Deletar Hist�rico de Consulta
